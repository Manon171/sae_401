 ...
 */
class getCodeRegionRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CodeRegionRepository' shared autowired service.
     *
     * @return \App\Repository\CodeRegionRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CodeRegionRepository.php';

        return $container->privates['App\\Repository\\CodeRegionRepository'] = new \App\Repository\CodeRegionRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
