 ...
 */
class getStatistiqueLogementRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\StatistiqueLogementRepository' shared autowired service.
     *
     * @return \App\Repository\StatistiqueLogementRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'StatistiqueLogementRepository.php';

        return $container->privates['App\\Repository\\StatistiqueLogementRepository'] = new \App\Repository\StatistiqueLogementRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
